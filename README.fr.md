...
|---|---|---|
| **MSI** | Installation durable, déploiement par GPO | `msiexec /i FaultTracePC-1.2.1.msi` (ou double-clic) |
...
powershell -ExecutionPolicy Bypass -File installer\build-msi.ps1 -Version 1.2.1
```
