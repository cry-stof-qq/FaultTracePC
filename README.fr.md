...
|---|---|---|
| **MSI** | Installation durable, déploiement par GPO | `msiexec /i FaultTracePC-1.4.1.msi` (ou double-clic) |
...
`msiexec /i FaultTracePC-1.4.1.msi FTPCLANG=en /qn`. C'est un défaut — le choix
