...
| Format | For whom | How |
|---|---|---|
| **MSI** | Permanent install, GPO deployment | `msiexec /i FaultTracePC-1.4.0.msi` (or double-click) |
...
`msiexec /i FaultTracePC-1.4.0.msi FTPCLANG=en /qn`. It is a default — a user's
