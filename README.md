...
| Format | For whom | How |
|---|---|---|
| **MSI** | Permanent install, GPO deployment | `msiexec /i FaultTracePC-1.3.1.msi` (or double-click) |
...
`msiexec /i FaultTracePC-1.3.1.msi FTPCLANG=en /qn`. It is a default — a user's
