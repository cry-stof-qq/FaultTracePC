<#
    ...
    Installation silencieuse manuelle :  msiexec /i FaultTracePC-1.3.1.msi /qn
    Désinstallation silencieuse :        msiexec /x FaultTracePC-1.3.1.msi /qn

    LANGUE IMPOSÉE AU POSTE (facultatif) :
        msiexec /i FaultTracePC-1.3.1.msi FTPCLANG=en /qn
