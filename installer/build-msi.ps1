<#
    ...
    Installation silencieuse manuelle :  msiexec /i FaultTracePC-1.4.0.msi /qn
    Désinstallation silencieuse :        msiexec /x FaultTracePC-1.4.0.msi /qn

    LANGUE IMPOSÉE AU POSTE (facultatif) :
        msiexec /i FaultTracePC-1.4.0.msi FTPCLANG=en /qn
